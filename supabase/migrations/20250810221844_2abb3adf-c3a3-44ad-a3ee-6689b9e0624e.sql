...
CREATE TABLE public.marketing_campaigns (
  ...
  metrics JSONB DEFAULT '{}', -- impressions, clicks, leads, cost_per_lead, etc.
  platforms TEXT[] DEFAULT '{}', -- facebook, google, zillow, etc.
  creative_assets JSONB DEFAULT '[]', -- images, videos, copy
